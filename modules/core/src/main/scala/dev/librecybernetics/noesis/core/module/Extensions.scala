package dev.librecybernetics.noesis.core.module

import java.time.LocalDate

import cats.data.NonEmptyList
import dev.librecybernetics.noesis.core.capture.Intent
import dev.librecybernetics.noesis.core.policy.{Disclosure, DisclosurePolicy, PolicyBook, SupportResolver}
import dev.librecybernetics.noesis.core.projection.KbState
import dev.librecybernetics.noesis.core.verbalize.{Naming, NamingContext}
import dev.librecybernetics.noesis.logic.{AxiomAnnotations, Iri}
