...
import dev.librecybernetics.noesis.core.module.{ExportContext, ExportOptions}
...
class PrmSuite extends CatsEffectSuite:
  ...
  test("structured capture rejects every malformed boundary with a specific problem"):
    ...
    assertEquals(
      ...
      Iri("noesis:e/prm-email-98bddc81fc85741d69cf")
    )
  ...
  test("vCard writing maps every current contact method and obeys UTF-8 line folding"):
    ...
    assertEquals(
      ...
      "BEGIN:VCARD\r\n" +
        "VERSION:4.0\r\n" +
        "UID:https://noesis.librecybernetics.dev/e/lia\r\n" +
        "FN:Lía García\r\n" +
        "N:García;Lía;;;\r\n" +
        "BDAY:--05-12\r\n" +
  ...
  test("the PRM agenda maps exact entry kinds, summaries, dates, and overdue boundaries"):
    ...
    yield
      assertEquals(
        ...
        List(
          dev.librecybernetics.noesis.core.module.AgendaEntry(
            dated,
            lia,
